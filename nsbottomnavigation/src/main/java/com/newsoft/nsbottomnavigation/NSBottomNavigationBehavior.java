...
import com.newsoft.nsbottomnavigation.NSBottomNavigation.OnNavigationPositionListener;

/**
 *
 */
public class NSBottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
	 ...
	 * Constructor
	 */
	public NSBottomNavigationBehavior() {
		super();
	}

	public NSBottomNavigationBehavior(boolean behaviorTranslationEnabled, int navigationBarHeight) {
		super();
		this.behaviorTranslationEnabled = behaviorTranslationEnabled;
		this.navigationBarHeight = navigationBarHeight;
	}

	public NSBottomNavigationBehavior(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public static <V extends View> NSBottomNavigationBehavior<V> from(V view) {
		...
		CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
				.getBehavior();
		if (!(behavior instanceof NSBottomNavigationBehavior)) {
			throw new IllegalArgumentException(
					"The view is not associated with AHBottomNavigationBehavior");
		}
		return (NSBottomNavigationBehavior<V>) behavior;
	}
